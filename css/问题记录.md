...
**背景**
一个 div 中包含了 img 和文字，div 没有设置高度，应该是 img 有多高，就会撑多高，给 div 设置一个边框查看效果，发现图片下方多了一点空白。
...
<div>
  <img
    src="https://assets.ecaisys.com/2025/3/26/VPNY0708U8/7/5fddbe26a54a965cf9131234953f19fe.png"
    width="200px"
    height="200px"
  />啊
</div>
...
改完后，虽然 div2 和 div3 的 z-index 都是2，但 div3 会覆盖 div2，是因为堆叠上下文规则和源代码顺序

当z-index值相同时，CSS规则是：按 HTML 源代码顺序，后出现的元素覆盖前面的
